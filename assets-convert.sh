...
do
    ...
    # inkscape -w $s -h $s10 assets-src/gents.svg -o assets-tmp/gents-mip$level.png
    ...
    inkscape -w $s10 -h $s10 assets-src/sprites.svg -o assets-tmp/sprites-mip$level.png
    ...
    # magick convert assets-tmp/gents-mip$level.png -crop 1x10@ +repage +adjoin PNG32:assets-tmp/out-gents-sprite%d-mip$level.png
...
# toktx --layers 10 $KTXOPTS assets/tilemap/gents.ktx2 assets-tmp/out-gents-*.png
