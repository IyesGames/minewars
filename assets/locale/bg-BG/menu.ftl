...
menu-button-play-lan = LAN & други сървъри
menu-button-offline = Обучение, Тренировка, Инструменти
...
menu-tooltip-play-lan = Играй да домашната мрежа или на свои сървъри.
menu-tooltip-offline = Научи се как да играеш, пробвай офлайн игри, инструменти...
