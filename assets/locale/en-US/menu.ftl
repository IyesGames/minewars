...
menu-button-play-lan = LAN & Custom Servers
menu-button-offline = Learn to Play & Offline Practice
...
menu-tooltip-play-lan = Play on your home network or join community servers!
menu-tooltip-offline = Tutorial, Offline Game Modes, Replays, Tools...
